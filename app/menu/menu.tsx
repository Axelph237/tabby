    ...
    <main className="h-screen w-screen overflow-y-auto">
      <div className="flex flex-col">
        <div className="flex flex-row items-end justify-end">
          ...
          {/*</div>*/}
          <div className="bg-primary tl-corner h-[16px] w-[16px]"></div>
          <div className="bg-primary relative right-0 h-[85px] w-1/2 rounded-tl-2xl rounded-tr-2xl">
            <h1 className="font-dongle text-accent flex items-center justify-center text-[64px] font-semibold">
              Menu
            </h1>
          </div>
        </div>
        <div className="bg-primary flex flex-col items-center gap-10 rounded-tl-2xl p-[20px] sm:p-[30px] md:p-[50px] lg:p-[60px]">
  ...
  return (
    <div className="relative flex w-full justify-center">
      ...
      <div className="absolute flex w-full flex-row">
        {/* shape - body */}
        <div className="bg-secondary h-[200px] w-2/3 rounded-tl-2xl rounded-br-2xl rounded-bl-2xl"></div>
        {/* shape - info */}
        <div className="flex w-1/3 flex-col">
          <div className="bg-secondary h-[150px] w-full rounded-tr-2xl rounded-br-2xl"></div>
          <div className="bg-secondary br-corner h-[16px] w-[16px]"></div>
        </div>
      </div>
            {/* Added comment */}
      {/* Sections */}
      <div className="relative flex h-[200px] w-full flex-row gap-[10px] p-[10px]">
        ...
        <div className="absolute right-0 bottom-0 flex h-[50px] w-1/3 items-center justify-center p-[5px]">
          <div className="bg-accent flex size-full cursor-pointer items-center justify-center rounded-xl font-bold">
            Add
          </div>
        </div>
      </div>
