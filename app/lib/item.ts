...
// 			item.details.selections?.push(selections[i]);
...
// 						item.details.totalPrice += option.args[i].price;
// 						break;
// 					}
// 				}
// 			} else if (
...
// 		item.details.selectKey = JSON.stringify(item.details.selections.sort());
//
// 		return item;
// 	};
//
...
//
// /**
//  * A selection made on an ItemTypeOption. Only necessary for types `one` and `many`.
...
//
// /**
//  * An Item representing a subunit of an ItemType. Each Item contains all necessary fields for identifying the ItemType and
//  */
